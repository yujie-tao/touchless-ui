...
BUILD_SETTINGS = BazelBuildSettings(
    '/usr/local/bin/bazel',
    '/private/var/tmp/_bazel_yujietao/10c522993e8e5c254541a86ff2253b04/execroot/mediapipe',
    'ios_x86_64',
    {
        'ios_arm64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/skytao/Library/Application Support/Tulsi/0.20190814.88/Bazel',
